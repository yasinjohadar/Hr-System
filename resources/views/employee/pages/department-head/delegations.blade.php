        ...
        <div class="container-fluid">
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('employee.department-head.delegations.create') }}" class="btn btn-primary btn-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($delegation->status === 'active')
                                                <form action="{{ route('employee.department-head.delegations.cancel', $delegation->id) }}" method="POST" class="d-inline">
                                                    @csrf
