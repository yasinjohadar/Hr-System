    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                ...
                <a href="{{ route('employee.department-head.delegations') }}" class="btn btn-outline-primary btn-sm">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-8">
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('employee.department-head.delegations.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="{{ route('employee.department-head.delegations') }}" class="btn btn-outline-secondary">
                                        إلغاء
                                    </a>
                                </div>
                            </form>
