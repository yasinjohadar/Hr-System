                ...
                <div class="header-content-left">
                    ...
                    <div class="header-element">
                        <div class="horizontal-logo">
                            <a href="{{ route('employee.dashboard') }}" class="header-logo hr-brand hr-brand--header">
                ...
                <div class="header-content-right">
                    ...
                    <div class="header-element Search-element d-block d-lg-none">
                        ...
                        <ul class="main-header-dropdown dropdown-menu dropdown-menu-end Search-element-dropdown" data-popper-placement="none">
                            <li>
                                <div class="input-group w-100 p-2 hr-search">
                                    <input type="search" class="form-control hr-search__input" placeholder="إكتب للبحث..." autocomplete="off" aria-label="بحث">
