        ...
        <aside class="app-sidebar sticky" id="sidebar">
            ...
            <div class="main-sidebar-header">
                <a href="{{ route('employee.dashboard') }}" class="header-logo hr-brand">
                    <span class="hr-brand__title">نظام الموارد البشرية</span>
                </a>
            </div>
            ...
            <div class="main-sidebar" id="sidebar-scroll">
                ...
                <nav class="main-menu-container nav nav-pills flex-column sub-open">
                    ...
                    <ul class="main-menu">
                        ...
                        <li class="slide">
                            <a href="{{ route('employee.hierarchy') }}" class="side-menu__item">
                                ...
                                <span class="side-menu__label">التسلسل الإداري</span>
                            </a>
                        </li>
