    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            <div class="page-header d-flex justify-content-between align-items-center my-4">
                <h5 class="page-title mb-0">إضافة رصيد إجازة جديد</h5>
            </div>

            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.leave-balances.store') }}" id="leaveBalanceForm">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="number" class="form-control @error('year') is-invalid @enderror" 
                                           ...
                                           value="{{ old('year', date('Y')) }}" required min="2020" max="2100">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="number" class="form-control @error('total_days') is-invalid @enderror" 
                                           ...
                                           value="{{ old('total_days') }}" required min="0">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="number" class="form-control" 
                                           id="remaining_days" placeholder="الأيام المتبقية" readonly>
                        ...
                        <div class="text-end mt-4">
                            ...
                            <button type="submit" class="btn btn-primary px-4">
                                <i class="fas fa-save me-2"></i>حفظ رصيد الإجازة
                            </button>
                        </div>
                    </form>
                </div>
