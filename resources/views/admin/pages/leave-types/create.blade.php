    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            <div class="page-header d-flex justify-content-between align-items-center my-4">
                <h5 class="page-title mb-0">إضافة نوع إجازة جديد</h5>
            </div>
                    ...
                    <form method="POST" action="{{ route('admin.leave-types.store') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                           name="name" placeholder="اسم نوع الإجازة" value="{{ old('name') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('name_ar') is-invalid @enderror" 
                                           name="name_ar" placeholder="اسم نوع الإجازة بالعربية" value="{{ old('name_ar') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('code') is-invalid @enderror" 
                                           name="code" placeholder="كود نوع الإجازة" value="{{ old('code') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="number" class="form-control @error('max_days') is-invalid @enderror" 
                                           name="max_days" placeholder="الحد الأقصى للأيام" value="{{ old('max_days') }}" min="0">
                            ...
                            <div class="col-md-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="is_paid" value="1" 
                                           id="is_paid" {{ old('is_paid', true) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="carry_forward" value="1" 
                                           id="carry_forward" {{ old('carry_forward') ? 'checked' : '' }}>
                        ...
                        <div class="text-end mt-4">
                            ...
                            <button type="submit" class="btn btn-primary px-4">
                                <i class="fas fa-save me-2"></i>حفظ نوع الإجازة
                            </button>
                        </div>
                    </form>
                </div>
