    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div class="my-auto">
                    <h5 class="page-title fs-21 mb-1">إضافة مهارة جديدة</h5>
                </div>
                <div>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.employee-skills.store') }}">
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="skill_name_ar" class="form-control" value="{{ old('skill_name_ar') }}">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="proficiency_level" class="form-select @error('proficiency_level') is-invalid @enderror" required>
                                    <option value="beginner" {{ old('proficiency_level') == 'beginner' ? 'selected' : '' }}>مبتدئ</option>
                                    <option value="intermediate" {{ old('proficiency_level', 'intermediate') == 'intermediate' ? 'selected' : '' }}>متوسط</option>
                                    <option value="advanced" {{ old('proficiency_level') == 'advanced' ? 'selected' : '' }}>متقدم</option>
                                    <option value="expert" {{ old('proficiency_level') == 'expert' ? 'selected' : '' }}>خبير</option>
                                </select>
