    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            <div class="page-header d-flex justify-content-between align-items-center my-4">
                <h5 class="page-title mb-0">إضافة مرشح جديد</h5>
            </div>
                    ...
                    <form method="POST" action="{{ route('admin.candidates.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('first_name') is-invalid @enderror" 
                                           name="first_name" placeholder="الاسم الأول" value="{{ old('first_name') }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('last_name') is-invalid @enderror" 
                                           name="last_name" placeholder="اسم العائلة" value="{{ old('last_name') }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('phone') is-invalid @enderror" 
                                           name="phone" placeholder="الهاتف" value="{{ old('phone') }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="text" class="form-control" 
                                           name="alternate_phone" placeholder="هاتف بديل" value="{{ old('alternate_phone') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="date" class="form-control" 
                                           name="date_of_birth" placeholder="تاريخ الميلاد" value="{{ old('date_of_birth') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" 
                                           name="current_position" placeholder="المنصب الحالي" value="{{ old('current_position') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" 
                                           name="current_company" placeholder="الشركة الحالية" value="{{ old('current_company') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="text" class="form-control" 
                                           name="education_level" placeholder="المستوى التعليمي" value="{{ old('education_level') }}">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" name="address" placeholder="العنوان" style="height: 80px">{{ old('address') }}</textarea>
                                    <label>العنوان</label>
                                </div>
                            </div>
                        ...
                        <div class="text-end mt-4">
                            ...
                            <button type="submit" class="btn btn-primary px-4">
                                <i class="fas fa-save me-2"></i>حفظ المرشح
                            </button>
                        </div>
                    </form>
                </div>
