    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div class="my-auto">
                    <h5 class="page-title fs-21 mb-1">إضافة شهادة جديدة</h5>
                </div>
                <div>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.employee-certificates.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="certificate_name_ar" class="form-control" value="{{ old('certificate_name_ar') }}">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="expiry_date" class="form-control" value="{{ old('expiry_date') }}" id="expiry_date">
                            </div>

                            <div class="col-md-6">
                                <div class="form-check mt-4">
                                    <input type="checkbox" name="does_not_expire" class="form-check-input" value="1" 
                                           id="does_not_expire" {{ old('does_not_expire') ? 'checked' : '' }}>
                                    <label class="form-check-label" for="does_not_expire">لا تنتهي صلاحيتها</label>
                                </div>
                            </div>

                            <div class="col-md-12">
                                <label class="form-label">ملف الشهادة (اختياري)</label>
