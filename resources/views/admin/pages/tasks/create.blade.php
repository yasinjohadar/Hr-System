    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div class="my-auto">
                    <h5 class="page-title fs-21 mb-1">إضافة مهمة جديدة</h5>
                </div>
                <div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                                    ...
                                    <option value="in_review" {{ old('status') == 'in_review' ? 'selected' : '' }}>قيد المراجعة</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="estimated_hours" class="form-control" min="0" value="{{ old('estimated_hours') }}">
                            </div>
