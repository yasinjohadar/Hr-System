    ...
    <div class="main-content app-content">
        <div class="container-fluid admin-page-shell">
            ...
            <div class="admin-page-banner">
                <div class="admin-page-banner-main">
                    ...
                    <div class="admin-page-banner-text">
                        <h1>إضافة إعداد ضريبة جديد</h1>
                        <p>حدّد نوع الضريبة وطريقة احتسابها وحدودها وفترة صلاحيتها</p>
                    </div>
                </div>
            ...
            <div class="admin-page-card">
                <form class="admin-form" method="POST" action="{{ route('admin.tax-settings.store') }}">
                    @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('type') is-invalid @enderror" name="type" required>
                                    ...
                                    <option value="income_tax" @selected(old('type') === 'income_tax')>ضريبة الدخل</option>
                                    <option value="social_insurance" @selected(old('type') === 'social_insurance')>التأمينات الاجتماعية</option>
                                    <option value="health_insurance" @selected(old('type') === 'health_insurance')>التأمين الصحي</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('calculation_method') is-invalid @enderror" name="calculation_method" required id="calculation_method">
                                    ...
                                    <option value="percentage" @selected(old('calculation_method') === 'percentage')>نسبة مئوية</option>
                                    <option value="slab" @selected(old('calculation_method') === 'slab')>شرائح</option>
                                    <option value="fixed" @selected(old('calculation_method') === 'fixed')>ثابت</option>
                                </select>
...
@section('js')
    <script>
         ...
         *
         * نستخدم السمة hidden لا style.display — نفس النمط المتّبع في بقية
         * نماذج الرواتب — حتى لو لم يكن هذا العنصر بالذات داخل شبكة Bootstrap
         * يتأثّر بذلك، فالاتساق أهم من التوفير.
         */
        (function () {
