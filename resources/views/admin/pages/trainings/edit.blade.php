    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            <div class="page-header d-flex justify-content-between align-items-center my-4">
                <h5 class="page-title mb-0">تعديل دورة تدريبية</h5>
            </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.trainings.update', $training->id) }}">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('code') is-invalid @enderror" 
                                           ...
                                           value="{{ old('code', $training->code) }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="time" class="form-control" 
                                           ...
                                           value="{{ old('start_time', $training->start_time ? $training->start_time->format('H:i') : '') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="time" class="form-control" 
                                           ...
                                           value="{{ old('end_time', $training->end_time ? $training->end_time->format('H:i') : '') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="number" class="form-control" 
                                           ...
                                           value="{{ old('duration_hours', $training->duration_hours) }}" min="0">
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="number" class="form-control" 
                                           ...
                                           value="{{ old('cost', $training->cost) }}" min="0" step="0.01">
                                    <label>التكلفة</label>
                                </div>
                            </div>
                                ...
                                <div class="form-floating">
                                    <select class="form-select" name="currency_id" id="currency_id">
                                        ...
                                        @foreach ($currencies as $currency)
                                            <option value="{{ $currency->id }}" {{ old('currency_id', $training->currency_id) == $currency->id ? 'selected' : '' }}>
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" name="description" placeholder="الوصف" style="height: 100px">{{ old('description', $training->description) }}</textarea>
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" name="description_ar" placeholder="الوصف بالعربية" style="height: 100px">{{ old('description_ar', $training->description_ar) }}</textarea>
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" name="objectives" placeholder="الأهداف" style="height: 100px">{{ old('objectives', $training->objectives) }}</textarea>
                                    <label>الأهداف</label>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" name="content" placeholder="المحتوى" style="height: 100px">{{ old('content', $training->content) }}</textarea>
                                    <label>المحتوى</label>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" name="materials" placeholder="المواد التدريبية" style="height: 100px">{{ old('materials', $training->materials) }}</textarea>
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" name="notes" placeholder="ملاحظات" style="height: 100px">{{ old('notes', $training->notes) }}</textarea>
                                    <label>ملاحظات</label>
                                </div>
                            </div>
                        </div>
