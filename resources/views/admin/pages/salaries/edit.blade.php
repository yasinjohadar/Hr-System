    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            <div class="page-header d-flex justify-content-between align-items-center my-4">
                <h5 class="page-title mb-0">تعديل راتب: {{ $salary->employee->full_name ?? $salary->employee->first_name . ' ' . $salary->employee->last_name }}</h5>
            </div>

            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.salaries.update', $salary->id) }}" id="salaryForm">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <select class="form-select @error('salary_month') is-invalid @enderror" 
                                        ...
                                        @for ($i = 1; $i <= 12; $i++)
                                            <option value="{{ $i }}" {{ old('salary_month', $salary->salary_month) == $i ? 'selected' : '' }}>
                            ...
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <input type="number" class="form-control @error('salary_year') is-invalid @enderror" 
                                           ...
                                           value="{{ old('salary_year', $salary->salary_year) }}" required min="2020" max="2100">
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="number" step="0.01" class="form-control @error('base_salary') is-invalid @enderror" 
                                           ...
                                           value="{{ old('base_salary', $salary->base_salary) }}" required min="0">
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="number" step="0.01" class="form-control @error('allowances') is-invalid @enderror" 
                                           ...
                                           value="{{ old('allowances', $salary->allowances) }}" min="0">
                                    <label>البدلات</label>
                                    @error('allowances')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="number" step="0.01" class="form-control @error('bonuses') is-invalid @enderror" 
                                           ...
                                           value="{{ old('bonuses', $salary->bonuses) }}" min="0">
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="number" step="0.01" class="form-control @error('overtime') is-invalid @enderror" 
                                           ...
                                           value="{{ old('overtime', $salary->overtime) }}" min="0">
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="number" step="0.01" class="form-control @error('deductions') is-invalid @enderror" 
                                           ...
                                           value="{{ old('deductions', $salary->deductions) }}" min="0">
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="number" step="0.01" class="form-control" 
                                           id="total_salary" placeholder="الراتب الإجمالي" 
                                           value="{{ $salary->total_salary }}" readonly>
                                    ...
                                    <select class="form-select @error('currency_id') is-invalid @enderror" 
                                        ...
                                        @foreach ($currencies as $currency)
                                            <option value="{{ $currency->id }}" 
                                                {{ old('currency_id', $salary->currency_id) == $currency->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="date" class="form-control @error('payment_date') is-invalid @enderror" 
                                           ...
                                           value="{{ old('payment_date', $salary->payment_date?->format('Y-m-d')) }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <select class="form-select @error('payment_status') is-invalid @enderror" 
                                        ...
                                        <option value="pending" {{ old('payment_status', $salary->payment_status) == 'pending' ? 'selected' : '' }}>قيد الانتظار</option>
                                        <option value="paid" {{ old('payment_status', $salary->payment_status) == 'paid' ? 'selected' : '' }}>مدفوع</option>
                                        <option value="cancelled" {{ old('payment_status', $salary->payment_status) == 'cancelled' ? 'selected' : '' }}>ملغي</option>
                                    </select>
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control @error('notes') is-invalid @enderror" 
                                              name="notes" placeholder="ملاحظات" style="height: 100px">{{ old('notes', $salary->notes) }}</textarea>
                                    <label>ملاحظات</label>
                                    @error('notes')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        @include('admin.pages.salaries._ledger_form', ['activeAdvances' => $activeAdvances, 'salary' => $salary])
