    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            <div class="page-header d-flex justify-content-between align-items-center my-4">
                <h5 class="page-title mb-0">إضافة موظف جديد</h5>
            </div>
                    ...
                    <form method="POST" action="{{ route('admin.employees.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('employee_code') is-invalid @enderror" 
                                           name="employee_code" placeholder="رقم الموظف" value="{{ old('employee_code') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <select class="form-select @error('employment_type') is-invalid @enderror" name="employment_type" required>
                                        ...
                                        <option value="intern" {{ old('employment_type') == 'intern' ? 'selected' : '' }}>متدرّب</option>
                                        <option value="freelance" {{ old('employment_type') == 'freelance' ? 'selected' : '' }}>مستقل</option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="number" step="0.01" class="form-control @error('salary') is-invalid @enderror" 
                                           name="salary" placeholder="الراتب" value="{{ old('salary') }}">
                                    <label>الراتب</label>
                                    @error('salary')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="email" class="form-control @error('personal_email') is-invalid @enderror" 
                                           name="personal_email" placeholder="البريد الشخصي" value="{{ old('personal_email') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="tel" class="form-control @error('personal_phone') is-invalid @enderror" 
                                           name="personal_phone" placeholder="الهاتف الشخصي" value="{{ old('personal_phone') }}">
                        ...
                        <div class="text-end mt-4">
                            ...
                            <button type="submit" class="btn btn-primary px-4">
                                <i class="fas fa-save me-2"></i>حفظ بيانات الموظف
                            </button>
                        </div>
                    </form>
                </div>
