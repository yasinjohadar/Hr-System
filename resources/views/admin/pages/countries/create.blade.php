    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            <div class="page-header d-flex justify-content-between align-items-center my-4">
                <h5 class="page-title mb-0">إضافة دولة جديدة</h5>
            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                           name="name" placeholder="اسم الدولة بالإنجليزية" value="{{ old('name') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('name_ar') is-invalid @enderror" 
                                           name="name_ar" placeholder="اسم الدولة بالعربية" value="{{ old('name_ar') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('code') is-invalid @enderror" 
                                           name="code" placeholder="كود الدولة" value="{{ old('code') }}" required maxlength="2">
                                    <label>كود الدولة (2 أحرف) <span class="text-danger">*</span></label>
                                    <small class="form-text text-muted">مثال: SA, US, EG</small>
                                    @error('code')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('code3') is-invalid @enderror" 
                                           name="code3" placeholder="كود الدولة 3 أحرف" value="{{ old('code3') }}" maxlength="3">
                                    <label>كود الدولة (3 أحرف)</label>
                                    <small class="form-text text-muted">مثال: SAU, USA, EGY</small>
                                    @error('code3')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('phone_code') is-invalid @enderror" 
                                           name="phone_code" placeholder="رمز الهاتف" value="{{ old('phone_code') }}">
                                    <label>رمز الهاتف</label>
                                    <small class="form-text text-muted">مثال: +966, +1</small>
                                    @error('phone_code')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('currency_code') is-invalid @enderror" 
                                           name="currency_code" placeholder="رمز العملة" value="{{ old('currency_code') }}" maxlength="3">
                                    <label>رمز العملة</label>
                                    <small class="form-text text-muted">مثال: SAR, USD</small>
                                    @error('currency_code')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('flag') is-invalid @enderror" 
                                           name="flag" placeholder="العلم" value="{{ old('flag') }}" maxlength="10">
