    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div class="my-auto">
                    <h5 class="page-title fs-21 mb-1">إضافة مخالفة جديدة</h5>
                </div>
                <div>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.employee-violations.store') }}">
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="severity" class="form-select @error('severity') is-invalid @enderror" required>
                                    <option value="low" {{ old('severity', 'medium') == 'low' ? 'selected' : '' }}>منخفض</option>
                                    <option value="medium" {{ old('severity', 'medium') == 'medium' ? 'selected' : '' }}>متوسط</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="disciplinary_action_id" class="form-select">
                                    ...
                                    @foreach ($disciplinaryActions as $action)
                                        <option value="{{ $action->id }}" {{ old('disciplinary_action_id') == $action->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="leave_request_id" class="form-select">
                                    ...
                                    @foreach ($leaveRequests as $leave)
                                        <option value="{{ $leave->id }}" {{ old('leave_request_id') == $leave->id ? 'selected' : '' }}>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="witnesses" class="form-control" rows="2">{{ old('witnesses') }}</textarea>
                            </div>
