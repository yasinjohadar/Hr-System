    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            <div class="page-header d-flex justify-content-between align-items-center my-4">
                <h5 class="page-title mb-0">إضافة حساب بنكي جديد</h5>
                    ...
                    <form method="POST" action="{{ route('admin.bank-accounts.store') }}">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="bank_name_ar" value="{{ old('bank_name_ar') }}">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="iban" value="{{ old('iban') }}" maxlength="34">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">SWIFT Code</label>
                                <input type="text" class="form-control" name="swift_code" value="{{ old('swift_code') }}" maxlength="11">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">اسم صاحب الحساب</label>
                                <input type="text" class="form-control" name="account_holder_name" value="{{ old('account_holder_name') }}">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('account_type') is-invalid @enderror" name="account_type" required>
                                    ...
                                    <option value="salary" {{ old('account_type') == 'salary' ? 'selected' : '' }}>راتب</option>
                                </select>
                                @error('account_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('currency_code') is-invalid @enderror" 
                                       name="currency_code" value="{{ old('currency_code', 'SAR') }}" maxlength="3" required>
                                @error('currency_code')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
