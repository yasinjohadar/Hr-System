    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div class="my-auto">
                    <h5 class="page-title fs-21 mb-1">كافة الأقسام</h5>
                </div>
            </div>
            <!-- Page Header Close -->
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex gap-3">
                            ...
                            <a href="{{ route('admin.departments.create') }}" class="btn btn-primary btn-sm">إضافة قسم جديد</a>
                            @endcan
                            ...
                            <div class="flex-shrink-0">
                                <div class="form-check form-switch form-switch-right form-switch-md">
                                    <form action="{{ route('admin.departments.index') }}" method="GET"
                                        ...
                                        <a href="{{ route('admin.departments.index') }}" class="btn btn-danger">مسح</a>
                                    </form>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table table-striped table-hover align-middle table-nowrap mb-0">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th scope="col" style="min-width: 200px;">اسم القسم</th>
                                            <th scope="col" style="min-width: 120px;">الكود</th>
                                            <th scope="col" style="min-width: 150px;">المدير</th>
                                            <th scope="col" style="min-width: 150px;">القسم الأب</th>
                                    ...
                                    <tbody>
                                        @forelse ($departments as $department)
                                            ...
                                            @include('admin.pages.departments.delete')
                                        @empty
                                            <tr>
