    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div class="my-auto">
                    <h5 class="page-title fs-21 mb-1">إضافة قالب مستند جديد</h5>
                </div>
                <div>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.document-templates.store') }}">
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select @error('type') is-invalid @enderror" name="type" required>
                                    <option value="contract" {{ old('type', 'contract') == 'contract' ? 'selected' : '' }}>عقد عمل</option>
                                    <option value="letter" {{ old('type') == 'letter' ? 'selected' : '' }}>خطاب</option>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select @error('file_format') is-invalid @enderror" name="file_format" required>
                                    <option value="pdf" {{ old('file_format', 'pdf') == 'pdf' ? 'selected' : '' }}>PDF</option>
                                    <option value="docx" {{ old('file_format') == 'docx' ? 'selected' : '' }}>DOCX</option>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="content_ar" id="content_ar" class="form-control" rows="10">{{ old('content_ar') }}</textarea>
                            </div>
